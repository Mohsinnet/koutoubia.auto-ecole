...
function ExamCalendarView({ records }: { records: RecordItem[] }) {
  return <div className="mx-auto max-w-[1500px] px-5 py-7 sm:px-8 lg:px-12 lg:py-10"><div className="mb-8"><p className="mb-2 text-sm text-[#7c8d8d]">مواعيد امتحانات المترشحين مصنفة حسب التاريخ</p><h2 className="text-3xl font-bold tracking-tight">تقويم الامتحانات <span className="inline-block h-2 w-2 rounded-full bg-[#e8793a] align-middle" /></h2></div><ExamCalendar records={records} /></div>;
}
